...
export class CreateUsersTable1748373225114 implements MigrationInterface {
    name = 'CreateUsersTable1748373225114'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("created_by" character varying(100), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_by" character varying(100), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(100) NOT NULL, "phone_number" character varying(20) NOT NULL, "password" character varying(255) NOT NULL, "firstname" character varying(50) NOT NULL, "lastname" character varying(50) NOT NULL, "avatar" character varying(255), "status" character varying NOT NULL DEFAULT 'active', "signin_failed" integer NOT NULL DEFAULT '0', "date_block" TIMESTAMP, "confirm_email" boolean NOT NULL DEFAULT false, "have_confirm_email" boolean NOT NULL DEFAULT false, "have_two_factor" boolean NOT NULL DEFAULT false, "two_factor" character varying(255), "role_id" uuid NOT NULL, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_01eea41349b6c9275aec646eee0" UNIQUE ("phone_number"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
